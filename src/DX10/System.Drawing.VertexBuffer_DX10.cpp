/*
 * System.Drawing.VertexBuffer_DX10.cpp
 *
 *  Created on: Taiwan
 *      Author: player
 */
...
#include "../../include/DX10/System.Drawing.VertexBuffer.h"
...
namespace System {
	namespace Drawing {
		...
		VertexBuffer::VertexBuffer(ID3D10Buffer* pVertexBuffer)
		{
			_ptr = NULL;
			...
			if (pVertexBuffer) {
				...
				if (desc.BindFlags & D3D10_BIND_VERTEX_BUFFER) {
					_ptr = pVertexBuffer;
				}
			}
		}
